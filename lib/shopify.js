...
async function loginRoute(req, res, accessMode) {
  try {
    ...
    const authRoute = await Shopify.Auth.beginAuth(req, res, shop, '/api/auth/shopify/callback', accessMode !== 'online');
    console.log("New OAuth process starting. AccessMode online/online: ", accessMode, "authRoute is:", authRoute);
