...
async function loginRoute(req, res, accessMode) {
  try {
    ...
    const authRoute = await Shopify.Auth.beginAuth(req, res, shop, '/api/auth/shopify/callback', accessMode);
    console.log("New OAuth process starting. AccessMode online/offline: ", accessMode, "authRoute is:", authRoute);
